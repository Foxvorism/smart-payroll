...
@section('content')
            ...
            <div class="col bread-crumb">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><b>Data Siswa</b></li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="body">
        <div class="row">
            <div class="col">
                <div class="stat-card">
                    <i class="ph ph-users"></i> Jumlah Siswa Jenjang SD :
                </div>
            </div>
            <div class="col">
                <div class="stat-card">
                    <i class="ph ph-users"></i> Jumlah Siswa Jenjang SMP :
                </div>
            </div>
            <div class="col">
                <div class="stat-card">
                    <i class="ph ph-users"></i> Jumlah Siswa Jenjang SMA :
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Input Siswa Baru</h1>
